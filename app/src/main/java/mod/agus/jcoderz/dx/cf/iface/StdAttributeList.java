...
/**
 * Standard implementation of {@link mod.agus.jcoderz.dx.cf.iface.AttributeList}, which directly stores
 * an array of {@link mod.agus.jcoderz.dx.cf.iface.Attribute} objects and can be made immutable.
 */
public final class StdAttributeList extends FixedSizeList
    ...
    /** {@inheritDoc} */
    @Override
    public mod.agus.jcoderz.dx.cf.iface.Attribute findNext(mod.agus.jcoderz.dx.cf.iface.Attribute attrib) {
        int sz = size();
        int at;
